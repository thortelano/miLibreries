...
public class miFontChooser extends JComponent{
    ...
    private Dimension dimB=new Dimension(120,35); //TAMAÑO DE LOS BOTONES
    
    private String[] fontStyleNames = null;
    private String[] fontFamilyNames = null;
    private String[] fontSizeStrings = null;
    private miTextField fontFamilyTextField = null;
    private miTextField fontStyleTextField = null;
    private miTextField fontSizeTextField = null;
    ...
    private miTextField sampleText = null;

    /**
     * Constructs a <code>JFontChooser</code> object.
     * 
     **/
    public miFontChooser(){
     ...
     **/
    public miFontChooser(String[] fontSizeStrings){
    ...
    public miTextField newFontFamilyTextField(){
        if (fontFamilyTextField == null){
            fontFamilyTextField= new miTextField();
            fontFamilyTextField.addFocusListener(new TextFieldFocusHandlerForTextSelection(fontFamilyTextField));
            fontFamilyTextField.addKeyListener(new TextFieldKeyHandlerForListSelectionUpDown(newFontFamilyList()));
            fontFamilyTextField.getDocument().addDocumentListener(new ListSearchTextFieldDocumentHandler(newFontFamilyList()));
            fontFamilyTextField.setFont(DEFAULT_FONT);
            fontFamilyTextField.setColorBorder(colorBorder);

        }
        return fontFamilyTextField;
    }
    public miTextField newFontStyleTextField(){
        if (fontStyleTextField == null){
            fontStyleTextField = new miTextField();
            fontStyleTextField.addFocusListener(new TextFieldFocusHandlerForTextSelection(fontStyleTextField));
            fontStyleTextField.addKeyListener(new TextFieldKeyHandlerForListSelectionUpDown(newFontStyleList()));
            fontStyleTextField.getDocument().addDocumentListener(new ListSearchTextFieldDocumentHandler(newFontStyleList()));
            fontStyleTextField.setFont(DEFAULT_FONT);
            fontStyleTextField.setColorBorder(colorBorder);
        }
        return fontStyleTextField;
    }
    public miTextField newFontSizeTextField(){
        if (fontSizeTextField == null){
            fontSizeTextField = new miTextField();
            fontSizeTextField.addFocusListener(new TextFieldFocusHandlerForTextSelection(fontSizeTextField));
            fontSizeTextField.addKeyListener(new TextFieldKeyHandlerForListSelectionUpDown(newFontSizeList()));
            fontSizeTextField.getDocument().addDocumentListener( new ListSearchTextFieldDocumentHandler(newFontSizeList()));
            fontSizeTextField.setFont(DEFAULT_FONT);
            fontSizeTextField.setColorBorder(colorBorder);
        }
        return fontSizeTextField;
    }
    public JList newFontFamilyList(){
        if (fontNameList == null){
            fontNameList = new JList(getFontFamilies());
            fontNameList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
            fontNameList.addListSelectionListener(new ListSelectionHandler(newFontFamilyTextField()));
    ...
    public JList newFontStyleList(){
        if (fontStyleList == null){
            fontStyleList = new JList(getFontStyleNames());
            fontStyleList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
            fontStyleList.addListSelectionListener(new ListSelectionHandler(newFontStyleTextField()));
    ...
    public JList newFontSizeList(){
        if (fontSizeList == null){
            fontSizeList = new JList(this.fontSizeStrings);
            fontSizeList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
            fontSizeList.addListSelectionListener(new ListSelectionHandler(newFontSizeTextField()));
    ...
    public String getSelectedFontFamily(){
        String fontName = (String) newFontFamilyList().getSelectedValue();
        return fontName;
    }
    /**
    ...
    public int getSelectedFontStyle(){
        int index = newFontStyleList().getSelectedIndex();
    ...
    public int getSelectedFontSize(){
        int fontSize = 1;
        String fontSizeString = newFontSizeTextField().getText();
        while (true){
            try{
                ...
                fontSizeString = (String) newFontSizeList().getSelectedValue();
                newFontSizeTextField().setText(fontSizeString);
            }
        }
    ...
    protected JPanel getFontFamilyPanel(){
        if (fontNamePanel == null){
            ...
            JScrollPane scrollPane = new JScrollPane(newFontFamilyList());
            scrollPane.getVerticalScrollBar().setFocusable(false);
            scrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);

            JPanel p = new JPanel();
            p.setLayout(new BorderLayout());
            p.add(newFontFamilyTextField(), BorderLayout.NORTH);
            p.add(scrollPane, BorderLayout.CENTER);

            JLabel label = new JLabel(("Font Name"));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
            label.setLabelFor(newFontFamilyTextField());
    ...
    protected JPanel getFontStylePanel(){
        if (fontStylePanel == null){
            ...
            JScrollPane scrollPane = new JScrollPane(newFontStyleList());
            scrollPane.getVerticalScrollBar().setFocusable(false);
            scrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);

            JPanel p = new JPanel();
            p.setLayout(new BorderLayout());
            p.add(newFontStyleTextField(), BorderLayout.NORTH);
            p.add(scrollPane, BorderLayout.CENTER);

            JLabel label = new JLabel(("Font Style"));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
            label.setLabelFor(newFontStyleTextField());
    ...
    protected JPanel getFontSizePanel(){
        if (fontSizePanel == null){
            ...
            JScrollPane scrollPane = new JScrollPane(newFontSizeList());
            scrollPane.getVerticalScrollBar().setFocusable(false);
            scrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);

            JPanel p = new JPanel();
            p.setLayout(new BorderLayout());
            p.add(newFontSizeTextField(), BorderLayout.NORTH);
            p.add(scrollPane, BorderLayout.CENTER);

            JLabel label = new JLabel(("Font Size"));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
            label.setLabelFor(newFontSizeTextField());
    ...
    protected miTextField getSampleTextField(){
        if (sampleText == null){
            Border lowered = BorderFactory.createLoweredBevelBorder();

            sampleText = new miTextField(("AaBbYyZz"));
            //sampleText.setBorder(lowered);
            sampleText.setPreferredSize(new Dimension(300, 100));
            sampleText.setColorBorder(colorBorder);
        }
        return sampleText;
    }
    ...
    public void setSelectedFontFamily(String name){
        ...
        for (int i = 0; i < names.length; i++)
        {
            ...
            {
                newFontFamilyList().setSelectedIndex(i);
                break;
            }
        }
        updateSampleFont();
    ...
    public void setSelectedFontStyle(int style){
        for (int i = 0; i < FONT_STYLE_CODES.length; i++)
        {
            ...
            {
                newFontStyleList().setSelectedIndex(i);
                break;
            }
        }
        updateSampleFont();
    ...
    public void setSelectedFontSize(int size){
        ...
        for (int i = 0; i < this.fontSizeStrings.length; i++)
        {
            ...
            {
                newFontSizeList().setSelectedIndex(i);
                break;
            }
        }
        newFontSizeTextField().setText(sizeString);
        updateSampleFont();
    }
    /**
    ...
    protected JDialog createDialog(Component parent){
        ...
        miButton okButton = new miButton(okAction);
            okButton.setFont(DEFAULT_FONT);
            okButton.setColorBorder(colorBorder);
            okButton.setColorBackgroundUnSelect(Color.white);
            okButton.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
            okButton.setIcon(new ImageIcon(getClass().getResource("ok.png")));
            okButton.setPreferredSize(dimB);
        miButton cancelButton = new miButton(cancelAction);
            cancelButton.setFont(DEFAULT_FONT);
            cancelButton.setColorBorder(colorBorder);
            cancelButton.setColorBackgroundUnSelect(Color.white);
            ...
            cancelButton.setPreferredSize(dimB);
        ...
        layout.setHorizontalGroup(layout.createSequentialGroup()
            .addComponent(okButton,javax.swing.GroupLayout.PREFERRED_SIZE, dimB.width, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(cancelButton,javax.swing.GroupLayout.PREFERRED_SIZE, dimB.width, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(layout.createParallelGroup()
            .addComponent(okButton,javax.swing.GroupLayout.PREFERRED_SIZE, dimB.height, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(cancelButton,javax.swing.GroupLayout.PREFERRED_SIZE, dimB.height, javax.swing.GroupLayout.PREFERRED_SIZE)   
        );
